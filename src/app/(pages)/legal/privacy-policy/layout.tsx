...
const pageTitle : string = "Wetrocloud - Privacy Policy - Convert any unstructured data to structured LLM ready data. Power your AI applications with clean structured markdown from all types of resources. Web, File, Image, Audio, Video & Youtube."
...
export const metadata: Metadata = {
  ...
  icons: [
   ...
   openGraph: {
    ...
    description: pageDescription,
    type: 'website',
    url: 'https://wetrocloud.com/legal/privacy-policy',
    siteName : 'Wetrocloud',
    images: [
      {
