...
import nabalLogo from '@/app/assets/img/nabal-logo.png'
import nutonLogo from '@/app/assets/img/nuton-logo.png'
import fanIqLogo from '@/app/assets/img/faniq-logo.png'
...
import { API_REFERENCES_URL, BLOG_URL, BOOK_CALL_URL, CONSOLE_URL, DISCORD_URL, DOCS_DATA_EXTRACTION_URL, DOCS_MARKDOWN_CONVERTER_API_URL, DOCS_RAG_API_URL, LINKEDIN_URL, PLAYGROUND_URL, PRICING_URL, PRIVACY_POLICY_URL, TERMS_OF_SERVICE_URL, TWITTER_URL, YOUTUBE_URL } from '../constants/constants'
    ...
    <div>
          ...
          <div className="flex flex-col md:flex-row gap-8 justify-center items-stretch max-w-6xl mx-auto px-4">
            <div className="flex-1 bg-white rounded-lg shadow-none border border-gray-100 p-6 flex flex-col justify-between text-left">
                ...
                <div className="flex items-center mt-auto">
                  <Image src={nabalLogo} alt="Nabal Studios" className="inline-block w-10 h-10 rounded-full bg-gray-200 mr-4"/>
                  <div>
                    <div className="font-bold text-black text-sm">Nabal Studios</div>
                    <div className="text-xs text-gray-500">Software Development Agency</div>
                  </div>
                </div>
              </div>
              ...
              <div className="flex-1 bg-white rounded-lg shadow-none border border-gray-100 p-6 flex flex-col justify-between text-left">
                ...
                <div className="flex items-center mt-auto">
                  <Image src={nutonLogo} alt="Nuton.app" className="inline-block w-10 h-10 rounded-full bg-gray-200 mr-4"/>
                  <div>
                    <div className="font-bold text-black text-sm">Nuton.app</div>
                    <div className="text-xs text-gray-500">AI Edtech Tool</div>
                  </div>
                </div>
              </div>
              ...
              <div className="flex-1 bg-white rounded-lg shadow-none border border-gray-100 p-6 flex flex-col justify-between text-left">
                ...
                <div className="flex items-center mt-auto">
                  <Image src={fanIqLogo} alt="Nuton.app" className="inline-block w-10 h-10 rounded-full bg-gray-200 mr-4"/>
                  <div>
                    <div className="font-bold text-black text-sm">Fan iq</div>
                    <div className="text-xs text-gray-500">Sport Trivia App</div>
                  </div>
                </div>
              </div>
          </div>
        ...
        <div className="mt-20 bg-gray-100 py-16">
                ...
                <ul className="mt-5 space-y-3">
                    ...
                    <li><a href={PLAYGROUND_URL} target='_blank' className="hover:underline transition">Playground</a></li>
                </ul>
                </div>
