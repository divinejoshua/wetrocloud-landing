        ...
        <div className="mt-20 bg-gray-100 py-10">
                ...
                <div>
                    ...
                    <div className="flex space-x-4 mt-2">
                        <a href={LINKEDIN_URL} className="text-xl hover:text-gray-600"><Image src={linkedInLogo} alt="Wetrocloud" className="social-icon"/></a>
                        <a href="mailto:hello@wetrocloud.com" className="text-xl hover:text-gray-600"><Image src={emailLogo} alt="Wetrocloud" className="social-icon"/></a>
                    </div>
