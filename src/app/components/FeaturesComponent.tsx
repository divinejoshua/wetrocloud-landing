...
export default function FeaturesComponent() {
  return (
    ...
    <div className="container mx-auto text-center text-white">
      <h2 className="text-3xl text-white">Convert any data into LLM <br/>ready data</h2>
      <p className="mt-5 text-gray-400">Wetrocloud enables you to pull data from any source and create robust RAG applications.</p>
